...
def master():
    ...
    Cabin4.grid(row = 3, column = 0)
    girl13.pack()
    girl14.pack()
    girl15.pack()
    girl16.pack()
    
    Cabin5.grid(row = 4, column = 0)
    girl17.pack()
    girl18.pack()
    girl19.pack()
    girl20.pack()
    
    Cabin6.grid(row = 5, column = 0)
    girl21.pack()
    girl22.pack()
    girl23.pack()
    girl24.pack()
    
    Cabin7.grid(row = 6, column = 0)
    girl25.pack()
    girl26.pack()
    girl27.pack()
    girl28.pack()
    
    Cabin8.grid(row = 7, column = 0)
    girl29.pack()
    girl30.pack()
    girl31.pack()
    girl32.pack()
    
    Cabin9.grid(row = 8, column = 0)
    girl33.pack()
    girl34.pack()
    girl35.pack()
    girl36.pack()
    ...
    Cabin13.grid(row = 3, column = 0)
    boy13.pack()
    boy14.pack()
    boy15.pack()
    boy16.pack()
    
    Cabin14.grid(row = 4, column = 0)
    boy17.pack()
    boy18.pack()
    boy19.pack()
    boy20.pack()
    
    Cabin15.grid(row = 5, column = 0)
    boy21.pack()
    boy22.pack()
    boy23.pack()
    boy24.pack()
    
    Cabin16.grid(row = 6, column = 0)
    boy25.pack()
    boy26.pack()
    boy27.pack()
    boy28.pack()
    
    Cabin17.grid(row = 7, column = 0)
    boy29.pack()
    boy30.pack()
    boy31.pack()
    boy32.pack()
    
    Cabin18.grid(row = 8, column = 0)
    boy33.pack()
    boy34.pack()
    boy35.pack()
    boy36.pack() 
